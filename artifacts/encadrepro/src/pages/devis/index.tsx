...
import { useListDevis, useCreateDevis, useListClients, getListDevisQueryKey } from "@workspace/api-client-react";
              ...
              <Card className="glass-panel hover:bg-white/5 transition-all cursor-pointer group border-border/50">
                <CardContent className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-6 sm:justify-end">
                    <Badge variant="outline" className={statutColors[devis.statut] || ""}>
                      {devis.statut.charAt(0).toUpperCase() + devis.statut.slice(1).replace('_', ' ')}
                    </Badge>
