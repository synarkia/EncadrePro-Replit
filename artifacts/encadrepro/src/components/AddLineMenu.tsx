...
const TYPE_OPTIONS: {
...
}[] = [
  {
    ...
    accent: "from-violet-500/15 to-violet-500/5 border-violet-500/40 text-foreground",
    typeCodes: ["EN", "VR", "AU"],
  ...
  },
  {
    ...
    accent: "from-blue-500/15 to-blue-500/5 border-blue-500/40 text-foreground",
    typeCodes: ["FA"],
  ...
  },
  {
    ...
    accent: "from-green-500/15 to-green-500/5 border-green-500/40 text-foreground",
    typeCodes: ["SD"],
